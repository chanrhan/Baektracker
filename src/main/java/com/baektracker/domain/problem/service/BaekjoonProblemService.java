...
import com.baektracker.domain.problem.dto.response.ProblemInfo;
...
import com.baektracker.mapper.ProblemMapper;
...
//        System.out.printf("qwe get problem (%d) : %s\n", problemId, problem.titleKo());
    ...
    public WeeklyUsersProgressResponse getWeeklyUsersProgress(LocalDate fromDate) {
        ...
        List<CoSolver> coSolvedUsers = solvedProblemRepository.getCoSolverInfo(
